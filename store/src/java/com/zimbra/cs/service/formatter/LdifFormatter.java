...
public class LdifFormatter extends Formatter {
    ...
    public void formatCallback(UserServletContext context) throws UserServletException,
        ...
        try {
            ...
            for (Map<String, String> contactMap : allContacts) {
                toLDIFContact(contactMap, sb, galLdapAttrMap);
                sb.append(NEW_LINE);
            }
        } finally {
    ...
    protected void toLDIFContact(Map<String, String> contact, StringBuilder sb, String[] galLdapAttrMap) {
    ...
    private static String getContactKey(String[] contactAttrs) {
        String key = null;
        if (Arrays.asList(contactAttrs).contains(ContactConstants.A_fullName)) {
            key = ContactConstants.A_fullName;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_lastName)) {
            key = ContactConstants.A_lastName;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_email)) {
            key = ContactConstants.A_email;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_jobTitle)) {
            key = ContactConstants.A_jobTitle;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_workStreet)) {
            key = ContactConstants.A_workStreet;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_workCity)) {
            key = ContactConstants.A_workCity;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_workState)) {
            key = ContactConstants.A_workState;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_workPostalCode)) {
            key = ContactConstants.A_workPostalCode;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_workCountry)) {
            key = ContactConstants.A_workCountry;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_workPhone)) {
            key = ContactConstants.A_workPhone;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_workFax)) {
            key = ContactConstants.A_workFax;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_mobilePhone)) {
            key = ContactConstants.A_mobilePhone;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_homePhone)) {
            key = ContactConstants.A_homePhone;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_pager)) {
            key = ContactConstants.A_pager;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_company)) {
            key = ContactConstants.A_company;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_notes)) {
            key = ContactConstants.A_notes;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_office)) {
            key = ContactConstants.A_office;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_department)) {
            key = ContactConstants.A_department;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_initials)) {
            key = ContactConstants.A_initials;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_firstName)) {
            key = ContactConstants.A_firstName;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_userCertificate)) {
            key = ContactConstants.A_userCertificate;
        } else if (Arrays.asList(contactAttrs).contains(ContactConstants.A_userSMIMECertificate)) {
